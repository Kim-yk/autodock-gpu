...
PyMedia video encoder/decoder -- http://pymedia.org"""
        ...
        if gui:
            splash =  SplashScreen(about, noSplash=noSplash, app='Pmv')
    ...
    #                        libraries=libraries)
        ...
        for a in args:
            ...
            elif a[-4:] in ['.pdb', '.pqr', 'pdbq', 'mol2', '.cif', '.gro', '.f2d', '.sdf'] or a[-5:]=='pdbqs' or a[-5:]=='pdbqt':
                if os.path.isfile(a):
                    mv.readMolecule(a)
...
NONCRITICAL_DEPENDENCIES =['ZSI', 'geomutils', 'UTpackages', 'SpatialLogic', 'bhtree', 'sff', 'PyBabel', 'Volume', 'mslib', 'Vision', 'NetworkEditor', 'ARTK', 'PIL', 'symserv','QSlimLib', 'AutoDockTools', 'PyMead', 'isocontour','Support', 'IPython', 'Scenario2', 'PyAutoDock', 'memoryobject', 'cAutoDock', 'ARViewer', 'TkTreectrl', 'Bio', 'cairo', 'TkinterDnD2', 'pyglf']
